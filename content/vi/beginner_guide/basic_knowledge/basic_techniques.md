...
Tùy character sẽ có nhiều cách high jump khác nhau. Tìm hiểu thêm trong mục [Techniques](/techniques).
...
Tùy character sẽ có nhiều cách spring step khác nhau. Tìm hiểu thêm trong mục [Techniques](/techniques).
...
Tìm hiểu thêm trong mục [Techniques](/techniques).
...
Mỗi character đều có vài Oki tỉ lệ re-catch cao để setup. Tìm hiểu thêm ở mục [Techniques](/techniques).
